...
- (void)setAvtive:(BOOL)active {
    dispatch_async(dispatch_get_main_queue(), ^{
        [CATransaction begin];
        [CATransaction setDisableActions:YES];
        self->_deleteButton.hidden = !active;
        self->_label.layer.borderWidth = (active) ? 1/self->_scale : 0;
        self->_label.layer.shadowColor = [UIColor grayColor].CGColor;
        self->_label.layer.shadowOffset= CGSizeMake(0, 0);
        self->_label.layer.shadowOpacity = .6f;
        self->_label.layer.shadowRadius = 2.f;
        ...
        self->rectLayer1.hidden = self->rectLayer2.hidden = self->rectLayer3.hidden = !active;
        [CATransaction commit];
